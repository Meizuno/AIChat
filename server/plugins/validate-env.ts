...
// Fail-fast env validation. Runs once at server startup; if required
// config is missing/invalid the process exits immediately rather than
// surfacing a 500 on the first request that happens to need it.
