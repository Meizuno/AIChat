...
<template>
  ...
  <div v-else class="group my-4 overflow-hidden rounded-xl border border-slate-200/70 bg-slate-50 shadow-sm dark:border-slate-700/60 dark:bg-slate-950">
    <div v-if="filename || language" class="flex items-center justify-between border-b border-slate-200/70 bg-slate-100 px-4 py-2 dark:border-slate-700/60 dark:bg-slate-900">
