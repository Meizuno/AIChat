...
// MCP servers management, rendered as a workspace view inside the main panel
// (not a modal). Add a URL (with an optional name and the "use auth token"
// checkbox), toggle/enable, and delete. On any change we emit `changed` so the
// parent re-probes live tool status.
