  ...
  >
    ...
    <template v-if="!isMultiline">
      <textarea
        ...
        rows="1"
        placeholder="Message…"
        class="flex-1 resize-none bg-transparent text-base outline-none placeholder:text-muted overflow-hidden disabled:opacity-50 disabled:cursor-not-allowed"
        style="height: 28px"
    ...
    <template v-else>
      <textarea
        ...
        rows="1"
        placeholder="Message…"
        class="w-full resize-none bg-transparent text-base sm:text-sm outline-none placeholder:text-muted max-h-48 overflow-y-auto disabled:opacity-50 disabled:cursor-not-allowed"
        :disabled="props.disabled"
        @input="autoResize"
        @keydown="onKeydown"
      />
