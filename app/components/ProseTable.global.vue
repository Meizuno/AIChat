<template>
  <div class="relative my-5 w-full max-w-2xl overflow-hidden rounded-2xl border border-slate-200/70 bg-linear-to-br from-white to-slate-50 shadow-sm dark:border-slate-700/60 dark:from-slate-900 dark:to-slate-800">
